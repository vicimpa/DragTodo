import { ITodo, todoStore } from "data/todo";
...
export const App = () => {
  ...
  const [todos, setTodos] = useState<ITodo[]>(todoStore.get());
  ...
  const onKeydown = (i = 0) =>
    (e: ReactMouseEvent) => {
      ...
      const { clientX, clientY, offsetX: oX, offsetY: oY } = e.nativeEvent;
